        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-800 space-y-2 bg-gray-50 dark:bg-gray-900/50">
            ...
            {isIndexing && progress && (
                <div className="space-y-1">
                    ...
                    <div className="text-[10px] text-gray-500 truncate" title={progress.currentTask || ''}>
                    ...
                    <div className="h-1 w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                        <div 
                            ...
                            style={{ 
                                width: `${progress.percentage ?? (progress.total ? (progress.current! / progress.total * 100) : 0)}%` 
                            }}
                        />
                    </div>
                </div>
